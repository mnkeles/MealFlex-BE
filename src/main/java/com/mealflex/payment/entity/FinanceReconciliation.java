...
public class FinanceReconciliation extends BaseEntity {
    ...
    @Column(name="provider_collected_amount", nullable=false, precision=12, scale=2) private BigDecimal providerCollectedAmount;
    ...
    @Column(name="discrepancy_amount", nullable=false, precision=12, scale=2) private BigDecimal discrepancyAmount;

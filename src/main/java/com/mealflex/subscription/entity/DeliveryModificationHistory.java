...
public class DeliveryModificationHistory extends BaseEntity {
    ...
    @Enumerated(EnumType.STRING) @Column(name="request_type", nullable=false) @Builder.Default
    private DeliveryModificationRequestType requestType = DeliveryModificationRequestType.CHANGE;

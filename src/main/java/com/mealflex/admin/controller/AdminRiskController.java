...
public class AdminRiskController {
 ...
 @GetMapping public List<Map<String,Object>> list(){return service.list().stream().map(this::view).toList();}
 @PostMapping("/rescan") public Map<String,Object> rescan(){return Map.of("scanned",service.scanNow(),"message","Risk taraması tamamlandı.");}

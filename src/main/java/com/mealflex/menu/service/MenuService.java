...
public class MenuService {
    ...
    public MenuResponse createMenu(Long userId, CreateMenuRequest request) {
        ...
        Menu menu = Menu.builder()
                ...
                .priceEffectiveFrom(request.getPriceEffectiveFrom() == null ? java.time.LocalDate.now() : request.getPriceEffectiveFrom())
    ...
    public MenuResponse updateMenu(Long userId, Long menuId, CreateMenuRequest request) {
        ...
        menu.setPriceEffectiveFrom(request.getPriceEffectiveFrom() == null ? java.time.LocalDate.now() : request.getPriceEffectiveFrom());
    ...
    public List<MenuResponse> setBulkActive(Long userId, List<Long> menuIds, boolean active) {
        ...
        if (!active && menus.stream().anyMatch(menu -> subscriptionRepository.existsByMenuIdAndStatusIn(menu.getId(),
                List.of(com.mealflex.subscription.entity.SubscriptionStatus.ACTIVE, com.mealflex.subscription.entity.SubscriptionStatus.APPROVED, com.mealflex.subscription.entity.SubscriptionStatus.PENDING_APPROVAL, com.mealflex.subscription.entity.SubscriptionStatus.POSTPONED))))
